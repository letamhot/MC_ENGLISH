    ...
    public partial class frmDapAnKP : Form
    {
        ...
        private void loadUC(int cauHoiId, bool hienthidiem)
        {
            ...
            if (ds != null)
            {
                ...
                lblDA.Font = new Font("Arial", ds.dapanABC.Length > 50 ? 20 : ds.dapanABC.Length < 10 ? 26 : 24);
                lblDA.Text = ds.dapanABC;
            }
        ...
        // Hàm hỗ trợ điều chỉnh kích thước font chữ dựa trên độ dài của câu trả lời
        private void AdjustFontSize(Label label, string answer)
        {
            if (answer.Length > 40)
            {
                label.Font = new Font("Arial", 16);
            }
            else if (answer.Length > 0 && answer.Length < 10)
            {
