...
namespace MC_Project
{
    public partial class Login : Form
    {
        ...
        private void FrmMCForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            {
                Hide();
                ManHinhMC frmMC = new ManHinhMC(int.Parse(dt.Rows[0]["doiid"].ToString()));
                frmMC.FormClosed += new FormClosedEventHandler(FrmMCForm_FormClosed);
                frmMC.ShowDialog();
                Close();
            }
            else
